...
description: When the user wants to apply to startup accelerators, incubators, or
  fellowship programs. Also use when the user mentions "YC application", "Techstars",
  "accelerator", or "apply to programs".
metadata:
  related:
  - pitch-deck
  - fundraising-email
