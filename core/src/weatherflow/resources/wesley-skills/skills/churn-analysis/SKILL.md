---
name: churn-analysis
description: When the user needs to identify at-risk accounts, understand why customers
  are leaving, reduce churn rate, build health scores, design save plays, or create
  win-back campaigns.
metadata:
  related:
  - feedback-synthesis
