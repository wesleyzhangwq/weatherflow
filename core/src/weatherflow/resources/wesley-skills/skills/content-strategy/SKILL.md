...
description: When the user needs to plan, prioritize, or structure a content program
  -- including identifying content pillars, mapping content to the buyer journey,
  choosing content types, or building an editorial calendar.
metadata:
  related:
  - seo-technical
  - social-content
