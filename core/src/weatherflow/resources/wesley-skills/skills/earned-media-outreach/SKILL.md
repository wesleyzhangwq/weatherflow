...
description: When the user wants to get press coverage, appear on podcasts, or build
  relationships with journalists and content creators. Also use when the user mentions
  "podcast guesting", "press outreach", "PR", "media exposure", "get on podcasts",
