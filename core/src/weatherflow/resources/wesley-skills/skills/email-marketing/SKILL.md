...
description: When the user needs to design, write, or optimize email sequences --
  including welcome series, nurture campaigns, re-engagement flows, onboarding emails,
  or newsletter strategy.
metadata:
  related:
  - cold-outreach
  - content-strategy
