...
description: When the user needs to analyze, categorize, or extract actionable insights
  from customer feedback across multiple sources, especially feature requests.
metadata:
  related:
