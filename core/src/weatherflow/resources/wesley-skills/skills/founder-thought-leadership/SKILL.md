...
description: When the user wants to build personal brand, thought leadership, or IP
  as a founder on Twitter/X or LinkedIn. Also use when the user mentions "founder
  brand", "personal content", "build audience", or "grow my following".
metadata:
  related:
  - social-content
  - content-strategy
