---
name: github-actions
description: Build CI/CD pipelines with GitHub Actions — workflows, jobs, steps, triggers,
  caching, artifacts, matrix builds, secrets, environments, reusable workflows, and
  custom actions. Use when tasks involve automating tests, builds, deployments, code
  quality checks, or any GitHub-triggered automation.
license: Apache-2.0
metadata:
