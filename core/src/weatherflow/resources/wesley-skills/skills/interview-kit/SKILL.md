---
name: interview-kit
description: When the user needs to design an interview process, create interview
  questions, build scorecards, calibrate interviewers, or evaluate candidates for
  a role.
metadata:
  related:
  - job-description
