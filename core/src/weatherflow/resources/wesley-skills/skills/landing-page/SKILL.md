---
name: landing-page
description: When the user needs to create, critique, or optimize a landing page for
  conversion -- including headline rewrites, CTA placement, layout restructuring,
  or full page copy drafts.
metadata:
  related:
  - content-strategy
  - seo-technical
