---
name: privacy-policy
description: When the user needs to draft, review, or update a privacy policy for
  their product, or needs to understand data privacy obligations across jurisdictions.
metadata:
  related:
  - terms-of-service
  - soc2-prep
