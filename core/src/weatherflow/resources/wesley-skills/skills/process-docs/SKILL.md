---
name: process-docs
description: When the user needs to create SOPs, playbooks, runbooks, or other operational
  documentation that defines how a recurring process should be executed.
metadata:
  related:
  - support-docs
  - board-update
