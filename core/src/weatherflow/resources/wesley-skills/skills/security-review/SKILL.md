...
description: When the user needs a security assessment — threat modeling, vulnerability
  review, auth flow audit, dependency scanning, or says "is this secure", "review
  for vulnerabilities", "threat model", "security audit", "pen test prep".
metadata:
  related:
  - code-review
  - architecture-design
