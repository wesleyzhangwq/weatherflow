...
description: When the user wants to monitor reviews, mentions, and community sentiment
  about their own product. Also use when the user mentions "track our reviews", "what
  are people saying about us", "brand monitoring", "reputation management", or "review
  alerts".
metadata:
  related:
  - review-mining
