---
name: seo-technical
description: When the user needs a technical SEO audit, on-page optimization guidance,
  or help resolving crawlability, indexation, or performance issues that affect search
  rankings.
metadata:
  related:
  - content-strategy
