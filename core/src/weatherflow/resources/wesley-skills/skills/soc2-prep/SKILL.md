---
name: soc2-prep
description: When the user needs to prepare for SOC 2, build a compliance roadmap,
  assess security posture, quantify security risk, or says "we need SOC 2", "security
  audit", "compliance", "enterprise customer wants SOC 2", "CISO advice".
metadata:
  related:
  - privacy-policy
  - security-review
