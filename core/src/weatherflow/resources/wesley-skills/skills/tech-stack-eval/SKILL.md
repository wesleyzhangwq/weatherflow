...
description: When the user needs to choose between technologies, frameworks, or tools
  — or says "which framework should I use", "compare X vs Y", "should we migrate from
  X to Y", "what database should I use", "calculate TCO".
metadata:
  related:
  - architecture-design
  - cicd-setup
