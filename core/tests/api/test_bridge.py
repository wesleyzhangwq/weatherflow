...
def test_configured_bridge_token_gates_http_and_websocket(tmp_path: Path) -> None:
    ...
    with TestClient(app) as client:
        ...
        container = client.portal.call(RuntimeContainer.create, settings)
        ...
        client.portal.call(container.ledger.append, event)
        ...
        events = client.portal.call(lambda: container.ledger.list_after(None, limit=1000))
